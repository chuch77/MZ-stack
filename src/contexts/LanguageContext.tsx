...
const translations = {
  es: {
    ...
    'hero.ecommerce': 'Desarrollo completo de aplicaciones web, integrando frontend, backend y bases de datos en un solo stack.',
  ...
  en: {
    ...
    'hero.ecommerce': 'Complete web application development, integrating frontend, backend and databases in a single stack.',
